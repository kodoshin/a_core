from management.ai_bases import async_get_response_ai_1, async_get_response_ai_2_ultimate #get_response_ai_1, get_response_ai_2
...
async def ai_processing(prompt, files, components, chat, is_first_prompt, technology, attempt):
    ...
    try:
        chat_category = await sync_to_async(ChatCategory.objects.get)(type='ultimate')
