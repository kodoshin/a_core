from management.ai_bases import async_get_response_ai_2, async_get_response_ai_1_large #get_response_ai_1, get_response_ai_2
...
async def ai_processing(prompt, files, components, chat, is_first_prompt, technology, attempt):
    ...
    try:
        chat_category = await sync_to_async(ChatCategory.objects.get)(type='large')
